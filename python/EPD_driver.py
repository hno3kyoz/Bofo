		...
		for z in range(0,progress_len):
			for x in range(0,pWidth_pix*pheight_pix):
				if(z == 0):
					...
					w_buffer.insert(y,temp[x])					
					y = y + 1
		self.EPD_Dis_Part(xDot-xDot/16-4,xDot-xDot/16+8,(yDot-16*progress_len)/2-1,(yDot-16*progress_len)/2-1+16*progress_len,w_buffer,1)
		#2.Load progress bar
		y =0
		for z in range(0,progress_len):
			for x in range(0,pWidth_pix*pheight_pix):
				if(z == 0):
					...
					y = y + 1	
			self.EPD_Dis_Part(xDot-xDot/16-4,xDot-xDot/16+8,(yDot-16*progress_len)/2-1,(yDot-16*progress_len)/2-1+16*progress_len,w_buffer,1)
	def Dis_showtime(self,xStart,yStart,hour,minute,sec):
		len_s = 16
		...
		for z in range(0,8):
			for x in range(0,len_s):
				if z == 0 :
					...
					return 1
		self.EPD_Dis_Part(yStart,yStart+8,xDot-xStart-16*8,xDot-xStart-1,w_buffer,1)
